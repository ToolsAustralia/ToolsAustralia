...
- **Shop** — merchandise catalogue, cart, checkout and Stripe payment at `/shop`. Member tier discount (Tradie 5% / Foreman 10% / Boss 20%) applied at checkout; shipping free on orders of $100 or more, $10 flat below that; GST is inside the total, never added. An account is required to check out. See [docs/cart-shop-products/](docs/cart-shop-products/).
