...
- **Major Draw** — runs on the **27th of every month** at **8:30 PM AEST/AEDT**, broadcast **live on Facebook**. Entries freeze at **8:00 PM** on the same evening; purchases during the 30-minute freeze window route to the next cycle (28th-to-27th). The winner itself is picked by **[randomdraws.com.au](https://randomdraws.com.au)** (a govt-certified third-party random-draw service) — we export the locked entry list and store the verification URL per winner. One Grand Winner per cycle today.
