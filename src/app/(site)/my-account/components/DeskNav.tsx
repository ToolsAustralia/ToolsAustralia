      ...
      <div className="border-t border-token p-3">
        <div className="flex items-center gap-3 rounded-xl px-2 py-2">
          ...
          <div className="min-w-0 flex-1">
            <div data-cs-mask className="truncate text-sm font-bold text-primary-token dark:text-white">
              {formatDisplayName(firstName, lastName) || "Member"}
            </div>
            {email && <div data-cs-mask className="truncate text-xs text-muted-token">{email}</div>}
          </div>
          <Link
