  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-6 sm:py-12 lg:py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(238,0,0,0.15),transparent_50%)] pointer-events-none" />
      ...
      {!loading && winners.length > 0 && <WinnerTestimonySection winners={winners} />}
    </>
  );
}
