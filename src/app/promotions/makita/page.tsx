...
export async function generateMetadata(): Promise<Metadata> {
  const prizeSlug = getDefaultPrizeForToolsetSlug("makita");
...
export default function MakitaPromotionsPage() {
  return <ToolsetLandingPage toolsetSlug="makita" />;
}
