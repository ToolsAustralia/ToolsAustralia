...
export async function generateMetadata(): Promise<Metadata> {
  const prizeSlug = getDefaultPrizeForToolsetSlug("milwaukee");
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      url: `${baseUrl}/promotions/milwaukee`,
    },
    twitter: {
...
export default function MilwaukeePromotionsPage() {
  return <ToolsetLandingPage toolsetSlug="milwaukee" />;
}
