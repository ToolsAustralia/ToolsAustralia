...
export async function generateMetadata(): Promise<Metadata> {
  const prizeSlug = getDefaultPrizeForToolsetSlug("dewalt");
...
export default function DeWaltPromotionsPage() {
  return <ToolsetLandingPage toolsetSlug="dewalt" />;
}
