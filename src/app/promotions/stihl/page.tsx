...
export async function generateMetadata(): Promise<Metadata> {
  const prizeSlug = getDefaultPrizeForToolsetSlug("stihl");
...
export default function StihlPromotionsPage() {
  return <ToolsetLandingPage toolsetSlug="stihl" />;
}
