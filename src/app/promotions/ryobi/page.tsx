...
export async function generateMetadata(): Promise<Metadata> {
  const prizeSlug = getDefaultPrizeForToolsetSlug("ryobi");
...
export default function RyobiPromotionsPage() {
  return <ToolsetLandingPage toolsetSlug="ryobi" />;
}
