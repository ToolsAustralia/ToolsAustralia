          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-8 h-8 text-gray-700 hover:text-white transition-all duration-300 rounded-full hover:bg-gradient-to-br hover:from-red-600 hover:to-red-700 hover:scale-105 flex items-center justify-center"
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">
                  Complete activity history with filters and search
                </p>
              </div>
            </div>
          </div>
