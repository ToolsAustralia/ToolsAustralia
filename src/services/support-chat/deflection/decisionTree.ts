...
const INTENT_RULES: IntentRule[] = [
  ...
  // Active member but 0 / no entries yet — explain renewal-timing (precede id29 "where",
  // id33 registration). Excludes registration terms so "signed up but no entries" → id33.
  {
    faqId: "39",
    signals: [
      "0 entries",
      "zero entries",
      "no entries but active",
      "active but no entries",
      "active but 0 entries",
      "member but no entries",
      "member but 0 entries",
      "why no entries",
      "why do i have no entries",
      "why do i have 0 entries",
      "when do my entries",
      "when will my entries",
      "when do entries appear",
      "when do i get my entries",
      "when will i get my entries",
      "entries not showing",
      "entries not showing up",
      "entries not updated",
      "renewed but no entries",
      "renewed but 0 entries",
    ],
    excludes: ["signed up", "registered", "buy", "more", "cancel", "where"],
  },
