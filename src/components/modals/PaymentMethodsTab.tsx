      ...
      {!loading && !showAddForm && paymentMethods.length === 0 && (
        <div className="text-center py-8 sm:py-12 border-2 border-dashed border-gray-300 rounded-lg px-4">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-[#ee0000] to-[#ff4444] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-xs sm:text-sm font-semibold hover:from-[#cc0000] hover:to-[#e60000] disabled:opacity-60"
          >
        ...
        <div className="space-y-2 sm:space-y-3">
              ...
              >
                <div className="flex items-center justify-between gap-2 sm:gap-4">
                  <div className="flex items-center gap-2 sm:gap-4 flex-1 min-w-0">
                    <div className="flex items-center justify-center w-10 h-7 sm:w-12 sm:h-8 bg-gray-100 rounded-lg flex-shrink-0">
          ...
          <div className="pt-3 sm:pt-4 border-t border-gray-200">
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#ee0000] to-[#ff4444] text-white py-2 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold hover:from-[#cc0000] hover:to-[#e60000] disabled:opacity-60 flex items-center justify-center gap-1.5 sm:gap-2"
            >
              {isCreatingSetupIntent ? (
                <>
