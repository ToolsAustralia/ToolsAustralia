 ...
 *
 * UNIMPLEMENTED offers (Task 17 will replace this throw):
 *   unsubscribe_marketing → throws loudly so a regression that re-surfaces an
 *   unimplemented offer fails fast.
 */

import React, { useState } from "react";
import { ArrowRight, Check, PauseCircle, Ticket, Trophy, CalendarClock, ShieldCheck, Award, Lock, LogOut, BadgePercent } from "lucide-react";
