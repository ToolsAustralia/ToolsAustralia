...
export default function ParticipantsModal({ isOpen, onClose, majorDrawId, majorDrawName }: ParticipantsModalProps) {
  ...
  return (
    <ModalContainer isOpen={isOpen} onClose={onClose} size="4xl" height="fixed">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {isLoading && participants.length === 0 && (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-neutral-400">Loading participants...</p>
            </div>
          )}
          ...
          {!isLoading && participants.length === 0 && !error && (
            <div className="p-8 text-center text-gray-500 dark:text-neutral-400">
              ...
              <p className="text-lg font-medium text-gray-900 dark:text-neutral-100">No participants found</p>
          ...
          {participants.length > 0 && (
            <div className="p-4">
              {/* Table Header */}
              <div className="hidden md:grid md:grid-cols-12 gap-4 p-4 bg-gray-50 dark:bg-neutral-800/80 rounded-lg border border-gray-200 dark:border-neutral-700 mb-4 text-sm font-semibold text-gray-700 dark:text-neutral-200">
              ...
              <div className="space-y-3">
                {participants.map((participant) => (
                  <div
                    ...
                    className="p-4 border-2 border-gray-200 dark:border-neutral-600 rounded-lg hover:border-gray-300 dark:hover:border-neutral-500 hover:bg-gray-50 dark:hover:bg-neutral-800/40 transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1 dark:focus:ring-offset-neutral-900"
                  >
                    {/* Mobile View */}
                    <div className="md:hidden space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-neutral-400 mt-1">
                            <Mail className="w-4 h-4" />
                            <span className="truncate">{participant.email}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 bg-blue-100 dark:bg-blue-950/45 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-lg">
                    ...
                    <div className="hidden md:grid md:grid-cols-12 gap-4 items-center">
                      <div className="col-span-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-neutral-400">ID: {participant.userId.slice(-8)}</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-span-3">
                      ...
                      <div className="col-span-2">
                        {participant.mobile ? (
                          ...
                          <span className="text-gray-400 dark:text-neutral-500 text-sm">Not provided</span>
                        )}
                      </div>
                      <div className="col-span-2">
                        {participant.state ? (
                          ...
                          <span className="text-gray-400 dark:text-neutral-500 text-sm">Not specified</span>
                        )}
                      </div>
                      <div className="col-span-2 text-right">
                        <div className="inline-flex items-center gap-2 bg-blue-100 dark:bg-blue-950/45 text-blue-800 dark:text-blue-200 px-3 py-1.5 rounded-lg">
                          <Trophy className="w-4 h-4" />
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200 dark:border-neutral-700">
                        <div className="flex flex-wrap gap-2">
                          {participant.entriesBySource.membership && (
                            <span className="px-2 py-1 bg-blue-100 dark:bg-blue-950/45 text-blue-800 dark:text-blue-200 rounded text-xs font-medium">
                              Membership: {participant.entriesBySource.membership}
                            </span>
                          )}
                          {participant.entriesBySource["one-time-package"] && (
                            <span className="px-2 py-1 bg-green-100 dark:bg-green-950/40 text-green-800 dark:text-green-200 rounded text-xs font-medium">
                              One-time: {participant.entriesBySource["one-time-package"]}
                            </span>
                          )}
                          {participant.entriesBySource.upsell && (
                            <span className="px-2 py-1 bg-purple-100 dark:bg-purple-950/40 text-purple-800 dark:text-purple-200 rounded text-xs font-medium">
                              Upsell: {participant.entriesBySource.upsell}
                            </span>
                          )}
                          {participant.entriesBySource["mini-draw"] && (
                            <span className="px-2 py-1 bg-orange-100 dark:bg-orange-950/40 text-orange-800 dark:text-orange-200 rounded text-xs font-medium">
                              Mini-draw: {participant.entriesBySource["mini-draw"]}
                            </span>
                          )}
                          {participant.entriesBySource.referral && (
                            <span className="px-2 py-1 bg-pink-100 dark:bg-pink-950/40 text-pink-800 dark:text-pink-200 rounded text-xs font-medium">
                              Referral: {participant.entriesBySource.referral}
                            </span>
                          )}
                          {(participant.entriesBySource["bonus-entry-promo"] ?? 0) > 0 && (
                            <span className="px-2 py-1 bg-amber-100 dark:bg-amber-950/40 text-amber-800 dark:text-amber-200 rounded text-xs font-medium">
              ...
              {pagination.totalPages > 1 && (
                <div className="flex items-center justify-between mt-6 p-4 border-t border-gray-200 dark:border-neutral-700">
      ...
      {/* Footer */}
      <div className="px-6 py-4 border-t border-gray-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-900/80">
