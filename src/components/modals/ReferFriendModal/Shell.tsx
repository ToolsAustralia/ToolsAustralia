...
interface ShellProps {
  isOpen: boolean;
  onClose: () => void;
  /** Drives the frame-level [data-tier] CSS custom properties for tier theming.
   * Defaults to "tradie" when the user's tier is unknown. */
  tier: Tier;
  /** Modal body content. */
  children: ReactNode;
}

const Shell: React.FC<ShellProps> = ({ isOpen, onClose, tier, children }) => {
