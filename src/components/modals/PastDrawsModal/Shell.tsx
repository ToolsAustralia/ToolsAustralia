...
/** PastDrawsModal frame — backdrop + scroll-locked stage + close button.
 * Mirrors the Shell pattern used across the upgrade/cancel/refer suite. */
const Shell: React.FC<ShellProps> = ({ isOpen, onClose, children, labelledBy }) => {
  ...
  return (
    ...
    >
      ...
      {/* Wider stage than the auth modals — past draws are a list view */}
      <div
        className="relative w-full max-w-[640px] font-sans text-neutral-950 antialiased max-h-[82dvh] flex max-xs:max-h-[88dvh]"
        role="dialog"
        aria-modal="true"
