          ...
          {drawType === "major" && (
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-red-600 font-['Inter'] bg-white transition-all duration-200"
              />
