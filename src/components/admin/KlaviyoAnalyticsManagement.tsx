...
export default function KlaviyoAnalyticsManagement() {
  ...
  const { data: resp, isLoading, isError, error } = useKlaviyoAnalytics("last_30_days");
  const [hourRange] = useState(() => defaultRange(new Date()));
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <Card className="p-5 min-w-0">
          <SectionTitle title="Campaigns" subtitle="Klaviyo-attributed revenue · last 30 days" icon={Mail} />
        ...
        <Card className="p-5 min-w-0">
          <SectionTitle title="Flows" subtitle="Klaviyo-attributed revenue · last 30 days" icon={Zap} />
      ...
      <Card className="p-5">
        <SectionTitle
          ...
          subtitle="From your payment attribution (convertingPlatform = klaviyo email + sms), last 30 days (AEST)"
          icon={Clock}
        />
        <DataTable<HourRow>
