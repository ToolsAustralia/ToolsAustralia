      ...
      <div className="flex items-center gap-1 sm:gap-2">
        {views.map(({ mode, label, shortLabel, icon: Icon }) => (
          <button
            ...
            className={`px-2 sm:px-3 py-1 sm:py-1.5 rounded-[11px] text-[10px] sm:text-[12px] font-bold transition-all duration-300 whitespace-nowrap focus:outline-none flex items-center gap-1 sm:gap-1.5 ${
              currentView === mode
