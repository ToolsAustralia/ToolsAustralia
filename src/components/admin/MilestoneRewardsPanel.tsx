        ...
        <div className="p-4 sm:p-6">
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              {rewards.map((reward) => (
                <article key={reward.id} className="rounded-xl border border-gray-200 bg-white p-3.5">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 flex flex-wrap gap-2 text-[11px] text-gray-500">
                        <span className="font-mono bg-gray-100 px-1.5 py-0.5 rounded">{reward.code}</span>
                      ...
                      <div className="mt-2 grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px]">
                        <div className="rounded-md bg-gray-50 px-2 py-1.5">
                          ...
                          <p className="font-semibold text-gray-900 mt-0.5">{reward.performance?.issuedCount ?? 0}</p>
                        </div>
                        <div className="rounded-md bg-gray-50 px-2 py-1.5">
                          <span className="text-gray-500">Redeemed</span>
                          <p className="font-semibold text-gray-900 mt-0.5">{reward.performance?.redeemedCount ?? 0}</p>
                        </div>
                        <div className="rounded-md bg-gray-50 px-2 py-1.5">
                          <span className="text-gray-500">Active</span>
                          <p className="font-semibold text-gray-900 mt-0.5">{reward.performance?.activeCount ?? 0}</p>
                        </div>
                        <div className="rounded-md bg-gray-50 px-2 py-1.5">
                          <span className="text-gray-500">Redeem Rate</span>
                          <p className="font-semibold text-gray-900 mt-0.5">{reward.performance?.redemptionRate ?? 0}%</p>
                        </div>
                      </div>
