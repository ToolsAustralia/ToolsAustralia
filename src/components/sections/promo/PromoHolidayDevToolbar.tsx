...
export function PromoHolidayDevToolbar({ forcedSlot, onForcedSlotChange }: PromoHolidayDevToolbarProps) {
  ...
  if (toolbarHidden) {
    return (
      <button
        type="button"
        className="pointer-events-auto fixed bottom-3 left-3 z-[10000] rounded-lg border border-amber-400/35 bg-neutral-950/95 px-2.5 py-1.5 text-[11px] font-semibold text-amber-100 shadow-[0_8px_28px_rgba(0,0,0,0.5)] backdrop-blur-md hover:bg-neutral-900/95"
        onClick={() => {
  ...
  return (
    <div
      className="pointer-events-auto fixed bottom-3 left-3 z-[10000] max-w-[min(22rem,calc(100vw-1.5rem))] rounded-xl border border-white/15 bg-neutral-950/92 px-3 py-2.5 text-[11px] text-neutral-100 shadow-[0_12px_40px_rgba(0,0,0,0.55)] backdrop-blur-md"
      role="region"
      ...
      <div className="mb-2 flex items-start justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-amber-400/45 bg-amber-950/70 px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-amber-100 shadow-[0_0_0_1px_rgba(0,0,0,0.2)] hover:bg-amber-900/80"
          >
            <X className="h-3.5 w-3.5 opacity-90" aria-hidden />
            Hide
          </button>
          <span className="rounded-md border border-white/15 bg-white/10 px-2 py-1 text-[10px] font-semibold uppercase text-white/80">
            Dev
          </span>
        </div>
      </div>
