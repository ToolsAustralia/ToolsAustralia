    ...
    >
      ...
      <div className="space-y-2 sm:space-y-2.5">
        ...
        <div className="flex items-center justify-between gap-2 pb-2 border-b border-slate-700/50">
          <span className="text-gray-300 text-[10px] sm:text-xs font-medium">Current</span>
        ...
        {/* Next Month */}
        <div className="flex items-center justify-between gap-2 pb-2 border-b border-slate-700/50">
          <span className="text-blue-300 text-[10px] sm:text-xs font-medium">Next Month</span>
          <span className="text-blue-400 font-bold text-[11px] sm:text-sm tabular-nums">
        ...
        <div className="flex items-center justify-between gap-2">
          <span className="text-green-300 text-[10px] sm:text-xs font-medium">Month 3</span>
          <span className="text-green-400 font-bold text-[11px] sm:text-sm tabular-nums">
