...
export default function WinnerCard({
  ...
  return (
    <article
      className={`overflow-hidden rounded-[24px] border bg-white shadow-[0_18px_42px_rgba(15,23,42,0.10)] dark:border-neutral-700 dark:bg-neutral-900 ${className}`}
