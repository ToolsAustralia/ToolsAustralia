...
export const upsellPackages: StaticUpsellPackage[] = [
  ...
  // Mini Draw Upsells
  {
    ...
    description: "Get 2 Free Entries with 1 Hour Access to Partner Discounts!",
    category: "one-time-plus",
    originalPrice: 1.0,
    discountedPrice: 0.5,
    ...
    entriesCount: 2,
    shopDiscountPercent: 0,
    partnerDiscountDays: 1 / 24,
    buttonText: "Upgrade Now - $0.5",
    conditions: [
      "$0.5 One Time Payment",
      "25% of Partner Discounts Available",
      "1 Hour Access to Partner Discounts",
      "2 Free Entries",
    ],
    urgencyText: "Limited time offer!",
    priority: 10,
  ...
  },
  {
    ...
    description: "Get 50 Free Entries with 3 Days Access to Partner Discounts!",
    category: "one-time-plus",
    originalPrice: 25,
    discountedPrice: 12.5,
    ...
    conditions: [
      "$12.50 One Time Payment",
      "30% of Partner Discounts Available",
      "3 Days Access to Partner Discounts",
      "50 Free Entries",
    ],
    urgencyText: "Limited time offer!",
    priority: 10,
  ...
  },
  {
    ...
    description: "Get 100 Free Entries with 6 Days Access to Partner Discounts!",
    category: "one-time-plus",
    originalPrice: 50,
    ...
    conditions: [
      ...
      "50% of Partner Discounts Available",
      "6 Days Access to Partner Discounts",
      "100 Free Entries",
    ],
    urgencyText: "Limited time offer!",
    priority: 10,
  ...
  },
  {
    ...
    description: "Get 200 Free Entries with 15 Days Access to Partner Discounts!",
    category: "one-time-plus",
    originalPrice: 100,
    discountedPrice: 49.99,
    discountPercentage: 50,
    ...
    conditions: [
      "$49.99 One Time Payment",
      "60% of Partner Discounts Available",
      "15 Days Access to Partner Discounts",
      "200 Free Entries",
    ],
    urgencyText: "Limited time offer!",
    priority: 10,
  ...
  },
  {
    ...
    description: "Get 500 Free Entries with 30 Days Access to Partner Discounts!",
    category: "one-time-plus",
    originalPrice: 250,
    discountedPrice: 124.99,
    discountPercentage: 50,
  ...
  },
  {
    ...
    description: "Get 1000 Free Entries with 40 Days Access to Partner Discounts!",
    category: "one-time-plus",
    originalPrice: 1000,
    discountedPrice: 249.99,
    ...
    conditions: [
      "$249.99 One Time Payment",
      "80% of Partner Discounts Available",
      "40 Days Access to Partner Discounts",
      "1000 Free Entries",
    ],
    urgencyText: "Limited time offer!",
    priority: 10,
