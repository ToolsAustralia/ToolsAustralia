...
export function getSupportChatFaqEntries(): FaqEntry[] {
  ...
  return [
    ...
    // ── UPGRADE / DOWNGRADE / REACTIVATE / PAUSE ──────────────────────────────
    {
      ...
      answer:
        "Upgrading takes effect straight away: you pay the new tier's full monthly price now, and its extra free entries land in the current draw immediately. Your billing cycle resets to today — unless your renewal is anchored to the 24th, which stays put. Upgrade from [My Account → Membership](/my-account/membership) → **Manage plan**. (Not available while a payment is past due — resolve that first.)",
      category: "PAYMENTS",
    },
    {
      id: "23",
