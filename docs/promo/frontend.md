...
Removed `src/components/banners/FreezePeroidBanner.tsx` — zero consumers (verified). Part of a
site-wide unused-component sweep; see [docs/shared-ui/frontend.md](../shared-ui/frontend.md#dead-component-sweep-2026-07-01).
