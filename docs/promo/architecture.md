...
- **Mobile `kinTB` 21-28 arrived defective** and are held back via `SKIP_SOURCES` in the converter: they carry HiKOKI's sub-headline ("A 15 PIECE HIKOKI POWER TOOL KIT …") over Milwaukee / DeWalt / Makita / Ryobi artwork, contradicting both their own imagery and their desktop twins. Those four brands keep their previous, copy-correct mobile kinTB art until a re-export lands; 29/30 (real HiKOKI) shipped normally.
