...
- **`static.hotjar.com/c/hotjar-*.js`** — the dead legacy Hotjar tag inside GTM container GTM-TBCCQQVZ; fix is deleting that tag in the GTM UI (owner action), NOT allowlisting — loading a second session recorder was explicitly rejected in the 2026-07 audit.
