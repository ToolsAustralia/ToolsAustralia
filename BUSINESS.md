...
- **Anchored upgrades used to be impossible.** Before 2026-08-24 the pay-first `billing_cycle_anchor: "now"` collided with the pending `trial_end` and Stripe returned a 400 on **every** attempt — a permanent, recurring revenue leak for the 25/26/27-joiner cohort, not an intermittent failure.
